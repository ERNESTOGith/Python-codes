...
#the EOF character at the end of it. The 2 input strings are asked by the program"""

                print("[Exercice 1]")

str1 = str(input('Please enter the first string value:'))
str2 = str(input('Please enter the second string value:'))
print(str1 + str2)
...
answer = input('Do you want to perform other calculation ? (yes/no):')
while answer == 'yes':
		              calculate()
answer = input('Do you want to perform other calculation ? (yes/no):')
